...
import { collection, getDocs, addDoc, serverTimestamp, Timestamp, doc, deleteDoc, updateDoc } from 'firebase/firestore'; 
...
export async function createWorkout(uid, workoutData) { 
  try { 
    ...
    await addDoc(workoutsRef, { 
      ...workoutData, 
      distance: Number(workoutData.distance), 
      duration: Number(workoutData.duration), 
      difficulty: Number(workoutData.difficulty), 
